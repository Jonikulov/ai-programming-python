...
def calculates_results_stats(results_dic):
    ...
    for value_list in results_dic.values():
        is_match, is_dog, as_dog = value_list[2], value_list[3], value_list[4]
    ...
    # Store count variables for calculating percentages
    ...
    if n_notdogs_img > 0:
        results_stats_dic["pct_correct_notdogs"] = (n_correct_notdogs /
                                                    n_notdogs_img) * 100
    else:
